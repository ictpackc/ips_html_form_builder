...
class HtmlFormController(http.Controller):
    ...
    def html_thanks(self, **kw):
        return http.request.render('ips_html_form_builder.html_thank_you', {})
    ...
    def form_field_config_general(self, **kw):
        ...
        for my_field in request.env['ir.model.fields'].search([('ttype', 'in', data_types_list), ('model_id.model', '=', values['form_model']), ('name', '!=', 'display_name')]):
            field_options_html += "<option value=\"" + str(my_field.id) + "\">" + my_field.field_description + " (" + my_field.name + "/" + str(my_field.ttype) + ")" + "</option>\n"
    ...
    def _generate_html_date_picker(self, field):
        ...
        html_output += "  <label class=\"control-label\" for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
        html_output += "  <div class=\"input-group date\">\n"
        html_output += "    <input type=\"text\" class=\"form-control\" id=\"" + field.html_name + "\" name=\"" + field.html_name + "\""
    ...
    def _generate_html_textbox(self, field):
        ...
        html_output += "\" for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
        ...
        html_output += "\" class=\"form-control\" name=\"" + field.html_name + "\""
    ...
    def _generate_html_textarea(self, field):
        ...
        html_output += "  <label class=\"control-label\" for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
        html_output += "  <textarea class=\"form-control\" name=\"" + field.html_name + "\""
    ...
    def _generate_html_html(self, field):
        """Generate textarea HTML"""
        html_output = ""
        html_output += "<div class=\"hff hff_textarea form-group\" data-form-type=\"" + field.field_type.html_type + "\" data-field-id=\"" + str(field.id) + "\">\n"
        html_output += "  <label class=\"control-label\" for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
    ...
    def _generate_html_file_select(self, field):
        ...
        html_output += "<div class=\"hff hff_binary form-group\" data-form-type=\"" + field.field_type.html_type + "\" data-field-id=\"" + str(field.id) + "\">\n"
        html_output += "  <label class=\"control-label\" for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
        html_output += "  <input name=\"" + field.html_name + "\" type=\"file\"/>\n"
        html_output += "</div>\n"
    ...
    def _generate_html_input_group(self, field):
        ...
        html_output += "<script>\n"
        html_output += "  $(function() {\n"
        html_output += "    $( \"#" + field.html_name + "_add\" ).click(function(e) {\n"
        html_output += "      e.preventDefault();\n"
        html_output += "      $( \"#" + field.html_name + "_container\" ).append( '<div class=\"row form-group\">' + $( \"#" + field.html_name + "_placeholder\").html() + '</div>');\n"
        html_output += "    });\n"
        html_output += "  });\n"
        html_output += "</script>\n"
    ...
    def _generate_html_radio_group_selection(self, field):
        ...
        for selection_value, selection_label in selection_list.items():
            ...
            html_output += "    <label><input type=\"radio\" name=\"" + field.html_name + "\" value=\"" + selection_value + "\"/>" + selection_label + "</label>\n"
            html_output += "  </div>\n"
    ...
    def _generate_html_checkbox_group(self, field):
        ...
        html_output += "  <label for=\"" + field.html_name + "\">" + field.field_label + "</label>\n"
    ...
    def _generate_html_checkbox_boolean(self, field):
        ...
        html_output += "><input type=\"checkbox\" name=\"" + field.html_name + "\"/>" + field.field_label + "</label>\n"
        html_output += "</div>\n"
    ...
    def _generate_html_dropbox(self, field):
        ...
        html_output += "  <label class=\"control-label\" for=\"" + field.html_name + "\">" + field.field_label
        html_output += "</label>\n"
        html_output += "  <select class=\"form-control\" name=\"" + field.html_name + "\""
    ...
    def load_form(self, **kw):
        ...
        for field_name, field_value in kw.items():
                values[field_name] = field_value
        print(values['form_id']['val'])
        html_form = request.env['html.form'].browse(int(values['form_id']['val']))
    ...
    def _process_html_html(self, field, field_data, values):
        html_response = HtmlFieldResponse()
        html_response.error = ""
